...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('@layouts/tabs-layout/tabs-layout.component').then(m => m.TabsLayoutComponent),
    children: [
      ...
      {
        path: 'qr-check',
        loadComponent: () => import('@features/qr-check/pages/qr-check/qr-check.component').then(m => m.QrCheckComponent),
      },
      {
        path: 'grades',
        loadComponent: () => import('@features/grades/pages/grades/grades.component').then(m => m.GradesComponent),
      },
      {
        path: 'attendance',
